...
infofile='/Users/Coleman/Research/MDCS/Example_Data/Curate/lammps15May2015_Al/info.sigma'+repr(sigmaval)+'.txt'
...
for i in range(0,1000):
    ...
    datafile=datadir+'/lammps15May15.Al.sigma'+repr(sigmaval)+'_'+repr(int(index))+'.dat'
    d = open(datafile,'r')
    d.readline()
    d.readline()
    line2=d.readline()
    ...
    UIDGB=uuid.uuid4()
    GBname='Al.sigma'+repr(sigmaval)+'_'+repr(int(index))
    ...
    recordfile=datadir+'/lammps15May15.Al.sigma'+repr(sigmaval)+'_'+repr(int(index))+'.xml'
    recordname='lammps15May15.Al.sigma'+repr(sigmaval)+'_'+repr(int(index))
