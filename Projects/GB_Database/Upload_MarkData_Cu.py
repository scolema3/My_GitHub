...
# Sigma 5, 13 = 0, 0, 1
sigmaval=11
tilt=numpy.array([1, -1, 0])


recordtemplate='/Users/Coleman/Research/MDCS/Example_Data/Curate/template-record-tschopp-Cu-data.xml'
infofile='/Users/Coleman/Research/MDCS/Example_Data/Curate/lammps15May2015_Cu/info.sigma'+repr(sigmaval)+'.txt'
datadir='/Users/Coleman/Research/MDCS/Example_Data/Curate/lammps15May2015_Cu'
...
for i in range(0,1000):
    ...
    datafile=datadir+'/lammps15May15.Cu.sigma'+repr(sigmaval)+'_'+repr(int(index))+'.dat'
    d = open(datafile,'r')
    d.readline()
    d.readline()
    line2=d.readline()
    ...
    UIDGB=uuid.uuid4()
    GBname='Cu.sigma'+repr(sigmaval)+'_'+repr(int(index))
    ...
    replacements = {'HERE_CALCULATION_KEY_HERE':str(UIDRecord),
                    ...
                    'HERE_GBE_HERE':str(Cu_GBE),
                    'HERE_GBSTRUCTURE_BLOB_HERE':str(url)
                    }

    recordfile=datadir+'/lammps15May15.Cu.sigma'+repr(sigmaval)+'_'+repr(int(index))+'.xml'
    recordname='lammps15May15.Cu.sigma'+repr(sigmaval)+'_'+repr(int(index))
