...
recordtemplate='/data/Research/GB_Database/Tschopp_Data/template-record-tschopp-Cu-data.xml'
infofile='/data/Research/GB_Database/Tschopp_Data/lammps15May2015_Cu/info.stgb'+repr(stgbval)+'.txt'
datadir='/data/Research/GB_Database/Tschopp_Data/lammps15May2015_Cu'
...
for i in range(0,1000):
    ...
    datafile=datadir+'/lammps15May15.Cu.stgb'+repr(stgbval)+'_'+repr(int(index))+'.dat'
    d = open(datafile,'r')
    d.readline()
    d.readline()
    line2=d.readline()
    ...
    UIDGB=uuid.uuid4()
    GBname='Cu.stgb'+repr(stgbval)+'_'+repr(int(index))
    ...
    recordfile=datadir+'/lammps15May15.Cu.stgb'+repr(stgbval)+'_'+repr(int(index))+'.xml'
    recordname='lammps15May15.Cu.stgb'+repr(stgbval)+'_'+repr(int(index))
