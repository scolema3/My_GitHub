...
reference_mode = raw_input('Do you want to generate from a single reference or a configuration file (respond single or config):\n')
...
if reference_mode=='single':
	...
	rescale_factor = float(raw_input('Input a scaling factor (1 if no change desired, must be greater than 0):\n'))
