...
// omp_set_num_threads(nthreads);
   ...
   printf("LP = %d\n",LP);
// printf("outside the parallel region, there are %d openMP thread(s) available\n",omp_get_max_threads());
// ==========================================================
...
// ==========================================================
  ...
  if (me == 0 && echo) {
    if (screen)
      ...
      fprintf(screen," \nTime ellapsed Within CPU LOOP = %0.2f ", tCPU1-tCPU0);
  }
